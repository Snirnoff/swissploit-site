...
2. **Sign out all active sessions**
   ...
   ![Microsoft 365: sign out user from all sessions](assets/blog/image-20260226-125126.webp)
   ![Entra ID: revoke the user sessions](assets/blog/image-20260226-125428.webp)
...
3. **Review MFA (multi-factor authentication)**
   ...
   ![Entra ID: review authentication methods and remove unknown MFA methods](assets/blog/image-20260226-125651.webp)
...
5. **(Optional, recommended) Check OneDrive/Teams/SharePoint**
   ...
   ![OneDrive: sort “Shared by you” by “Recently shared”](assets/blog/image-20260226-125948.webp)
...
7. **Review audit logs (sign-ins)**
   ...
   ![Entra ID: review sign-in logs for unusual locations and impossible travel](assets/blog/image-20260226-123042.webp)
...
10. **Review Conditional Access / Security Defaults**
   ...
   ![Entra ID: review risk-based conditional access and named locations for changes](assets/blog/image-20260226-124257.webp)
...
11. **Review registered apps / enterprise apps (OAuth consent)**
   ...
   ![Entra ID: review user applications, consent entries, and granted permissions](assets/blog/image-20260226-123558.webp)
